...
const translations = {
  en: {
    signInTitle: "Sign In",
    wrongCredentials: "The credentials you entered are wrong.<br>Please check them and try again.",
  ...
  gr: {
    signInTitle: "Σύνδεση",
    wrongCredentials: "Τα στοιχεία που εισαγάγατε είναι λανθασμένα.<br>Παρακαλώ ελέγξτε τα και προσπαθήστε ξανά.",
    emailPlaceholder: "Email",
    passwordPlaceholder: "Κωδικός",
    signInButton: "Σύνδεση",
    forgotPassword: "Ξεχάσατε τον κωδικό σας;",
    notAMember: "Δεν είστε ακόμη μέλος;",
