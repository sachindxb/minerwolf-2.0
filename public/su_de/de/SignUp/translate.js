...
const translations = {
  en: {
    ...
    disposableEmailError: "The email you entered is unacceptable.<br>Please check it and try again.<br>Disposable/Temp emails aren’t allowed!",
    legal: "LEGAL",
  ...
  gr: {
    ...
    disposableEmailError: "Το email που εισαγάγατε δεν είναι αποδεκτό.<br>Παρακαλώ ελέγξτε το και προσπαθήστε ξανά.<br>Οι προσωρινοί λογαριασμοί email δεν επιτρέπονται!",
    legal: "ΝΟΜΙΚΑ",
