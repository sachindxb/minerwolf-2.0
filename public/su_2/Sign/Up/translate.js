...
const translations = {
  en: {
    ...
    otpInstructions: "We have just sent you an email at:<br>[user’s email].<br>This PIN is valid for 5 minutes.",
    pinPlaceholder: "PIN",
  ...
  gr: {
    ...
    otpInstructions: "Σας στείλαμε email στη διεύθυνση:<br>[το email σας].<br>Αυτός ο κωδικός ισχύει για 5 λεπτά.",
    pinPlaceholder: "PIN",
